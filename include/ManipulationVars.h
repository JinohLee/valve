...
public:
    ...
    mat jacob_right, jacob_left, jacob_R, jacob_R_1, jacob_R_2, zeros6b8, jacob_right_new, jacob_left_new;
    ...
    mat pinv_jacob_right, pinv_jacob_left, pinv_jacob_R, Js_1, Js_2, pinv_Js_1, Jhat_2, pinv_Jhat_2, pinv_jacob_right_new, pinv_jacob_left_new;
    vec Theta_0_R, Theta_0_L, q_l, q_dot, tau, C_vel, q_ref, q_h, delta_q, delta_q_sum, null_vel, obj_r_T, obj_w_T, joint_error_ar;
